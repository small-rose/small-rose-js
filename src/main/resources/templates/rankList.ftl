<div class="ui large breadcrumb" style="margin-top: 20px;margin-bottom: 15px;">
    <a class="section" onclick="fillSearchText('${nickName}')">${nickName}</a>
...
<#if count??>
    <div class="ui message">
        <div class="ui  link large horizontal celled list">
            ...
            <#if count??>
                <span class="item filtered"><i class="ui icon file"></i>累计上榜</span>
            </#if>

        </div>
        <div style="color: rgba(0,0,0,.6);line-height: 1.6;">简书用户【 ${nickName} 】累计上榜 ${count} 次</div>
    </div>
</#if>
<!--
